...
TransShip.Scripts =
    {
        ...
        jsGetShipmentsByPO: function (customerId, PO, callback) {
            $.ajax("/api/shipments/GetByPO?CustomerId=" + customerId + "&PO=" +  PO, {
                type: "GET",
                success: function (data) {
                    if (typeof callback === 'function') {
                        callback(data);
        ...
        jsGetLastTwoShipment: function (customerId, state, callback) {
            $.ajax("/api/shipments/getLastTwoShipment?CustomerId=" + customerId + "&state=" + state, {
                type: "GET",
                success: function (data) {
                    if (typeof callback === 'function') {
                        callback(data);
        ...
        jsSaveShip: function (shipment, callback) {
            $.ajax("/api/ShipmetenService/post", {
                ...
                error: function (data) {
                    ...
                    if ( error.status == "2.1") {
                        toastr.error("Save error, type container already exist");
                    } else {
                        toastr.error("Error to save shipment");
                    }
                }
        ...
        jsCheckShipmentsByMembership: function (customerId, callback) {
            $.ajax("/api/shipments/GetCheckShipmentsByMembership?customerId=" + customerId, {
                type: "GET",
                success: function (data) {
                    if (typeof callback === 'function') {
                        callback(data);
                    ...
                    toastr.error("Error to get membership information");
                }
            });
        },
    }
