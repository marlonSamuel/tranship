...
model.paymentsController = {
    ...
    payment: {
        ...
        number_shipments: ko.observable(""),
    ...
    mapPayment: function (payment) {
        ...
        ePayment.initial_date(payment.initial_date);
        ePayment.final_date(payment.final_date);
        ePayment.number_shipments(payment.number_shipments);
        ePayment.max_number_shipments(payment.max_number_shipments);
    },
